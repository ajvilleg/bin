...
if ($#argv < 2) then
  echo "Usage:  101609-circular-g3-iterated.csh  <genome> <tag>"
  echo "           [step<i>  [only]]"
  echo ""
...
set awkpath = $HOME/molbin/glimmer3.02/scripts
set glimmerpath = $HOME/molbin/glimmer3.02/bin
set elphbin = $HOME/molbin/ELPH/bin/elph
