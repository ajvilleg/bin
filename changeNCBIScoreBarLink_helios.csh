...
find . | xargs grep -l "/usr/molbin/AutoFACT/bitscore.jpg" | xargs perl -p -i -e 's/\/usr\/molbin\/AutoFACT\/bitscore.jpg/http:\/\/www\.ncbi\.nlm\.nih\.gov\/blast\/images\/score\.gif/g'
